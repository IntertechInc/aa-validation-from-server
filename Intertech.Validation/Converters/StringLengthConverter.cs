...
namespace Intertech.Validation.Converters
{
    public class StringLengthConverter : BaseValidationConverter, IValidationConverter
    {
        ...
        public void Convert(string propertyName, string displayName, CustomAttributeData attr, StringBuilder jsonString, bool isFirstAttr, string resourceNamespace, string resourceAssemblyName)
        {
            ...
            {
                SetMaxLengthAAValidation(propertyName, displayName, attr, jsonString, isFirstAttr, maxLength, resourceNamespace, resourceAssemblyName);
            }
            ...
            {
                SetMinLengthAAValidation(propertyName, displayName, attr, jsonString, false, minLength, resourceNamespace, resourceAssemblyName);
            }
        }
    }
}
